<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="CustomerLogs.aspx.cs" Inherits="GraciaResto.CustomerLogs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <button class="btn btn-green-fill position-fixed bottom-0 end-0 mb-2 me-5" type="button" data-bs-toggle="modal" 
        data-bs-target="#add-customer-modal"><span class="d-xxl-inline d-none">New Customer</span><span class="fa fa-plus-circle d-xxl-none"></span></button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:LinkButton runat="server" ID="btnRecord" CssClass="btn btn-green-fill" OnClick="btnRecord_Click">
