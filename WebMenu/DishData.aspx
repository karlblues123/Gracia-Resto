<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="DishData.aspx.cs" Inherits="GraciaResto.DishData" %>
    ...
    <div class="container-fluid my-2">
        <asp:Panel runat="server" ID="pDishList">
                    ...
                    <div class="row">
                        ...
                        <div class="col-1 offset-5">
                            <asp:LinkButton runat="server" ID="btnReport" CssClass="btn btn-blue-fill float-end" OnClick="btnReport_Click">
                                <span class="d-xxl-inline d-none">Report</span>
                                <span class="fa fa-file d-xxl-none"></span>
                            </asp:LinkButton>
                        </div>
                    </div>
                </div>
            ...
            <asp:LinkButton runat="server" ID="btnNewDish" CssClass="btn btn-green-fill position-fixed bottom-0 end-0 mb-5 mb-xxl-2 me-5" 
                OnClick="btnNewDish_Click"><span class="d-xxl-inline d-none">New Dish</span><span class="fa fa-plus-circle d-xxl-none"></span></asp:LinkButton>
        </asp:Panel>
        <%-- Dish Form Panel --%>
                            ...
                            <div class="card" style="max-height:30vh">
                                ...
                                <div class="card-footer">
                                    ...
                                    <asp:LinkButton runat="server" ID="btnSaveAdjustment" CssClass="btn btn-green-fill float-end" 
                                        ...
                                        <span class="d-xxl-inline d-none">Save Stock</span>
                                        <span class="fa fa-save d-xxl-none"></span>
                                    </asp:LinkButton>
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-2 offset-10">
                                                    ...
                                                    <asp:LinkButton runat="server" ID="btnSaveRecipe" CssClass="btn btn-green-fill" OnClick="btnSaveRecipe_Click">
                                                        <span class="d-xxl-inline d-none">Save Recipe</span>
                                                        <span class="fa fa-save d-xxl-none"></span>
                                                    </asp:LinkButton>
                                                </div>
                                            </div>
