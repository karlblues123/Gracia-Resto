<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="PurchaseOrder.aspx.cs" Inherits="GraciaResto.PurchaseOrder" %>
                                    ...
                                    <asp:GridView runat="server" ID="gvIngredientList" CssClass="table table-responsive" AutoGenerateColumns="false" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Actual Price">
                                                ...
                                                <EditItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtActualPrice" CssClass="form-control" 
                                                        AutoCompleteType="Disabled" TextMode="Number" Text='<%#Eval("ActualPrice")%>'></asp:TextBox>
                                                </EditItemTemplate>
                                            </asp:TemplateField>
                                            <%-- Recevied Quantity --%>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            ...
                                            <asp:LinkButton runat="server" ID="btnPrint" CssClass="btn btn-blue-fill" OnClick="btnPrint_Click">
                                                <span class="fa fa-print d-xxl-none"></span>
                                                <span class="d-xxl-inline d-none">Print</span>
                                            </asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="card" style="height:70vh;">
                                                            <div class="card-header">
                                                                <input type="text" id="dish-search" autocomplete="off" class="form-control" />
                                                            </div>
                                                            <div class="card-body overflow-y-auto">
