<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GraciaResto.Login" %>
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card" id="logincard">
            <asp:Image runat="server" ID="iBannerImage" CssClass="card-img-top" ImageUrl="~/Content/images/Gracia-Resto-Logo.jpg" />
            <%-- Body --%>
            <div class="card-body">
                <%-- Username Textbox --%>
                <div class="row m-2">
