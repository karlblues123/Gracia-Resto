<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="ItemLogs.aspx.cs" Inherits="GraciaResto.ItemLogs" %>
    ...
    <div class="container-fluid my-2">
        <div class="card" style="max-height:85vh;">
            ...
            <div class="card-body overflow-y-auto">
                <%-- Logs GridView --%>
                <asp:GridView runat="server" ID="gvLogs" CssClass="table table-responsive" AutoGenerateColumns="false" DataKeyNames="ItemCode">
                    <Columns>
                        <asp:BoundField DataField="Name" HeaderText="Item" ItemStyle-Width="20%" />
