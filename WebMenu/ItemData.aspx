<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="ItemData.aspx.cs" Inherits="GraciaResto.ItemData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid my-2">
        ...
        <button class="btn btn-green-fill position-fixed bottom-0 end-0 mb-2 me-5" type="button" data-bs-toggle="modal" 
            data-bs-target="#add-item-modal"><span class="d-xxl-inline d-none">New Item</span><span class="fa fa-plus-circle d-xxl-none"></span></button>
        <%-- Add Item Modal --%>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:LinkButton runat="server" ID="btnAddNewItem" CssClass="btn btn-green-fill" OnClick="btnAddNewItem_Click">
                            <span class="fa fa-check-circle d-xxl-none"></span>
