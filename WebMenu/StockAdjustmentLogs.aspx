<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="StockAdjustmentLogs.aspx.cs" Inherits="GraciaResto.StockAdjustmentLogs" %>
        ...
        <div class="card" style="max-height:85vh;">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <%-- Search Textbox --%>
                        <input type="text" id="log-search" class="form-control" placeholder="Search" autocomplete="off" />
                    </div>
                </div>
            </div>
            <div class="card-body overflow-y-auto">
                ...
                <asp:GridView runat="server" ID="gvLogs" CssClass="table table-responsive" AutoGenerateColumns="false" DataKeyNames="ID">
                    <Columns>
                        ...
                        <asp:BoundField DataField="AdjustedStock" HeaderText="Stock" ItemStyle-Width="20%" />
