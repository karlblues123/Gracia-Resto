<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="GraciaResto.Menu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="navbar navbar-expand-lg sticky-md-top sticky-top" style="background-color:#fffbfc;">
        <div class="container-fluid">
            <%-- Logo --%>
            <h5 class="navbar-brand"><img src="Content/images/Gracia-Resto-Logo.jpg" style="width:30%;height:30%;" /></h5>
            <%-- Dropdown Navigation --%>
