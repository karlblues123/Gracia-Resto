<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="RoomLogs.aspx.cs" Inherits="WebMenu.RoomLogs" %>
    ...
    <div class="container-fluid my-2">
        <div class="card" style="max-height:85vh;">
            ...
            <div class="card-body overflow-y-auto">
                <%-- Logs GridView --%>
                <asp:GridView runat="server" ID="gvLogs" CssClass="table table-responsive" AutoGenerateColumns="false" DataKeyNames="Room">
                    <Columns>
                        <asp:BoundField DataField="Room" HeaderText="Customer" ItemStyle-Width="20%" />
