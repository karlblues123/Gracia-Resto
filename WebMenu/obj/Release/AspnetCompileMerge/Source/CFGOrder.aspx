<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CFGOrder.aspx.cs" Inherits="WebMenu.CFGOrder" %>
                        ...
                        <div class="card-footer" style="background-color:transparent !important;">
                            ...
                            <div class="row m-2 m-md-2">
                                <div class="col-6 offset-3">
                                    <div class="form-floating">
                                        <%-- Customer Location --%>
                                        <asp:TextBox runat="server" ID="txtCustomerLocation" CssClass="form-control fs-1" AutoCompleteType="Disabled"></asp:TextBox>
