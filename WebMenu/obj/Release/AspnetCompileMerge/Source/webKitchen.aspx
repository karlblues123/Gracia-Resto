<%@ Page Title="Restaurant Management System" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="webKitchen.aspx.cs" Inherits="WebMenu.webKitchen" %>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <ItemTemplate>
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <asp:Image runat="server" ID="iSoupImage" CssClass="img-thumbnail" ImageURL='<%#Eval("DishPhoto")!=DBNull.Value ? "data:Image/png;base64,"+ Convert.ToBase64String((byte[])Eval("DishPhoto")) : string.Empty %>' Width="100px" Height="85px" />
                                                            </div>
                                                            <div class="col">
                                                                <ul class="list-group">
                                                                    <li class="list-group-item border-0"><h5><%# Eval("DishName") %></h5></li>
                            ...
                            <div class="card-body">
                                <asp:GridView runat="server" ID="gvOrdersCompleted" AutoGenerateColumns="false" CssClass="table table-responsive">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Image runat="server" ID="iSoupImage" CssClass="img-thumbnail" ImageURL='<%#Eval("DishPhoto")!=DBNull.Value ? "data:Image/png;base64,"+ Convert.ToBase64String((byte[])Eval("DishPhoto")) : string.Empty %>' Width="50px" Height="50px" />
                                            </ItemTemplate>
