<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="Sales.aspx.cs" Inherits="WebMenu.Sales" %>
                ...
                <div class="tab-pane fade show active" id="form-pane">
                    ...
                    <div class="modal fade" tabindex="-1" id="customer-modal" aria-labelledby="CustomerModal">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <input type="text" id="customer-search" class="form-control" placeholder="Search" /> 
                                </div>
