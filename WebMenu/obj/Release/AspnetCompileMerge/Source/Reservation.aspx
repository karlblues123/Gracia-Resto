                                            ...
                                            <div class="row my-2">
                                                <div class="col">
                                                    ...
                                                    <asp:GridView runat="server" ID="gvReservation" CssClass="table table-responsive" AutoGenerateColumns="false" 
                                                        ...
                                                        ShowFooter="true" OnRowDeleting="gvReservation_RowDeleting">
                                                        <Columns>
                                                            <asp:BoundField DataField="Name" HeaderText="Selected Room" />
                ...
                <div class="modal-body">
                    <div class="row my-2">
                        <div class="col-6">
                            <div class="form-floating">
                                <%-- First Name --%>
                                <asp:Textbox runat="server" ID="txtGuestFirstName" CssClass="form-control" AutoCompleteType="Disabled"></asp:Textbox>
                                <label for="<%=this.txtGuestFirstName.ClientID%>">First Name</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-floating">
                                <%-- Last Name --%>
                                <asp:Textbox runat="server" ID="txtGuestLastName" CssClass="form-control" AutoCompleteType="Disabled"></asp:Textbox>
                                <label for="<%=this.txtGuestLastName.ClientID%>">Last Name</label>
                            </div>
                        </div>
                    </div>
                    <div class="row my-2">
