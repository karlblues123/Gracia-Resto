<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="ItemLogs.aspx.cs" Inherits="WebMenu.ItemLogs" %>
        ...
        <div class="card" style="max-height:85vh;">
            ...
            <div class="card-body overflow-y-auto">
                ...
                <asp:GridView runat="server" ID="gvLogs" CssClass="table table-responsive" AutoGenerateColumns="false" DataKeyNames="ItemCode">
                    <Columns>
                        <asp:BoundField DataField="Name" HeaderText="Customer" ItemStyle-Width="20%" />
