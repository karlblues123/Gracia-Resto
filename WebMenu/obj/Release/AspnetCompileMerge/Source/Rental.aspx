...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid my-2">
        <div class="row flex-nowrap my-2">
            ...
            <asp:HiddenField runat="server" ID="hiddenRepGuest" />
                                    ...
                                    <div class="row my-2">
                                        <div class="col">
                                            ...
                                            <asp:GridView runat="server" ID="gvRentals" AutoGenerateColumns="false" CssClass="table table-responsive" 
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="RentalName" HeaderText="Particulars" ReadOnly="true" ItemStyle-Width="15%" />
                                ...
                                <div class="col">
                                    <div class="card" style="max-height:85vh;">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-4">
                                                    <input type="text" autocomplete="off" id="search-bar"
                                                </div>
                                                <div class="col-4">
                                                    <div class="form-floating">
                                                        <%-- Start Date Filter --%>
