...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel runat="server" ID="pMenu" Visible="true">
        ...
        <asp:Label runat="server" ID="lblNoLocationAlert" CssClass="alert alert-danger position-fixed bottom-0 end-0 text-center" style="width:98vw;" Visible="false">No location found. Please scan the QR code to get the location.</asp:Label>
